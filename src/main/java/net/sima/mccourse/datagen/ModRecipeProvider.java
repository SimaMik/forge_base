...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    private List<ItemLike> ALEXANDRITE_SMELTABLES = List.of(ModItems.RAW_ALEXANDRITE.get(),ModBlocks.ALEXANDRITE_ORE.get(),
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
       ...
       // trapdoorBuilder(ModBlocks.ALEXANDRITE_TRAPDOOR.get(), Material..get());
    }
